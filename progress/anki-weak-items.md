# Item Lemah Anki (勉強の弱点) — Sumber Sinyal Kesulitan Empiris

> ⚙️ **FILE AUTO-GENERATED — jangan edit tangan.** Regenerasi dari collection Anki
> desktop dengan `bash scripts/sync-anki-weak-items.sh`. Sinyal = `lapses` (berapa
> kali kartu "gagal"/lupa) + tag `leech` Anki (🩸 = kartu bermasalah kronis).
> Ini **pelengkap** `evaluation.md` (kelemahan per POLA): file ini kelemahan per ITEM.

Dipakai `/quiz` & `/jlpt` untuk memilih **kendaraan kosakata/kanji** yang benar-benar
sering dilupakan — **di dalam** pola lemah dari `evaluation.md`. Bukan drill hafalan
arti (itu tugas Anki), tapi memaksa item sulit ini muncul di soal produksi.

Tingkat: **🔴** = `leech` atau `lapses ≥ 8` · **🟡** = `lapses 5–7` · **⚪** = `lapses 3–4`
(⚪ hanya dihitung, tak didaftar). **🩸** = bertag `leech`.

> Ringkasan cepat (anchor — baca ini saja saat quiz): PRIORITAS TINGGI 🔴
>
> **Verb/kosakata (Minna):** だします I 🩸, もらいます I 🩸, りょこう 🩸, おいくつ 🩸, きんがく 🩸, けします I 🩸, つけます II 🩸, となり 🩸, なくします I 🩸, おしえます II 🩸, おります II 🩸, かえします I 🩸, けんがくします III 🩸, じむしょ 🩸, てちょう 🩸, でかけます II 🩸, いつか 🩸, おつり 🩸, きゅうこう 🩸, げんきん 🩸, じこくひょう 🩸, だいたい 🩸, ついたち 🩸, つくります I 🩸, とります I 🩸, ひこうき 🩸, ふうとう 🩸
>
> **Kanji N5:** 生（せい） 🩸, 先（せん） 🩸, 年（ねん） 🩸, 千（せん） 🩸, 時（じ） 🩸, 北（きた） 🩸, 友（とも） 🩸, 会（あう） 🩸, 南（みなみ） 🩸, 東（ひがし） 🩸

Total ditandai — Minna: 🔴27 · 🟡55 · ⚪96  |  Kanji N5: 🔴10 · 🟡19 · ⚪28
...
| 🟡 | がくせい | siswa | L1 | 7 |
| 🟡 | きります I | memotong, menggunting | L7 | 7 |
| 🟡 | ことし | tahun ini | — | 7 |
...
| 🟡 | ふつう | biasa | — | 5 |
| 🟡 | ようじ | urusan | L9 | 5 |
| 🟡 | よやくします III | memesan (reservasi) | L18 | 5 |
...
---
_Auto-generated 2026-09-02 oleh `scripts/sync-anki-weak-items.sh` dari `collection.anki2`._
