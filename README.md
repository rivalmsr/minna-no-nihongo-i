...
│   └── lesson-21.md       <- 第21課: 〜と思います, 〜と言いました, 〜でしょう — pendapat, kutipan, konfirmasi
├── reference/
...
| [第21課 (Lesson 21)](lessons/lesson-21.md) | Pendapat, kutipan & konfirmasi | 〜と思います, 〜と言いました／言います (間接/直接「」), 〜でしょう？ (N/な-adj tanpa だ), 言葉 うごきます(が)・じどうしゃ/くるま・ぶっか/ねだん, でしょう/ね/よ | 言葉 ✅ · 練習A ✅ · 練習B ✅ |
